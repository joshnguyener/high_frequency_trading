...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/joshuanguyen/high_frequency_trading/venv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/joshuanguyen/high_frequency_trading/venv/bin/deactivate.nu'
